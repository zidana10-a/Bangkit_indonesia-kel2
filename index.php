        ...
        <div class="container position-relative">
            <div class="row gy-5" data-aos="fade-in">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
                    ...
                    <p>Generasi penerus bangsa Indonesia tidak boleh menelantarkan budaya bangsa, jadikan setiap usaha yang kita buat
                        berpengaruh pada negara Indonesia. Berideologi Pancasila, memegang teguh Bhinneka Tunggal Ika, memiliki rasa cinta Tanah Air, rela berkorban dan pantang menyerah serta memiliki kemahiran di bidang yang diminati.</p>

                </div>
                <div class="col-lg-6 order-1 order-lg-2">
                    <img src="assets/img/lambang_lagi.png" width= "400" align="right" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
                    <h4>Email</h4>
                    <strong>Email:</strong>dua@gmail.com<br>
